...
from resources.jwt_list import blp as RevokedJWTBlueprint
...
def create_app(db_url=None):
    ...
    def check_if_token_in_blocklist(jwt_header, jwt_payload):
        jti = JWTRevokedModel.query.filter(JWTRevokedModel.jti == jwt_payload["jti"]).first()
    ...
    api.register_blueprint(RevokedJWTBlueprint)
